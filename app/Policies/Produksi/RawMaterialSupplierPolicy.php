...
class RawMaterialSupplierPolicy
{
    /**
    ...
    {
        return $user->hasPermissionTo('viewAny-material_supplier');
    }
     ...
     */
    public function view(User $user, ?RawMaterialSupplier $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('view', User::class)
            return $user->hasPermissionTo('view-material_supplier');
        }

        // instance-based check
        return $user->hasPermissionTo('view-material_supplier') || $user->id === $model->id;
    }
    ...
    {
        return $user->hasPermissionTo('create-material_supplier');
    }
     ...
     */
    public function update(User $user, ?RawMaterialSupplier $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('update', User::class)
            return $user->hasPermissionTo('update-material_supplier');
        }

        return $user->hasPermissionTo('update-material_supplier') || $user->id === $model->id;
    }
     ...
     */
    public function delete(User $user, ?RawMaterialSupplier $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('delete', User::class)
            return $user->hasPermissionTo('delete-material_supplier');
        }
