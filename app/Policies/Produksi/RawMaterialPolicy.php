...
class RawMaterialPolicy
{
    ...
    {
        return $user->hasPermissionTo('viewAny-material');
    }
     ...
     */
    public function view(User $user, ?RawMaterial $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('view', User::class)
            return $user->hasPermissionTo('view-material');
        }

        // instance-based check
        return $user->hasPermissionTo('view-material') || $user->id === $model->id;
    }
    ...
    {
        return $user->hasPermissionTo('create-material');
    }
     ...
     */
    public function update(User $user, ?RawMaterial $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('update', User::class)
            return $user->hasPermissionTo('update-material');
        }

        return $user->hasPermissionTo('update-material') || $user->id === $model->id;
    }
     ...
     */
    public function delete(User $user, ?RawMaterial $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('delete', User::class)
            return $user->hasPermissionTo('delete-material');
        }
