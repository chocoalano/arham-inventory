...
class UnitConversationPolicy
{
    ...
    {
        return $user->hasPermissionTo('viewAny-unit_conversation');
    }
     ...
     */
    public function view(User $user, ?UnitConversation $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('view', User::class)
            return $user->hasPermissionTo('view-unit_conversation');
        }

        // instance-based check
        return $user->hasPermissionTo('view-unit_conversation') || $user->id === $model->id;
    }
    ...
    {
        return $user->hasPermissionTo('create-unit_conversation');
    }
     ...
     */
    public function update(User $user, ?UnitConversation $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('update', User::class)
            return $user->hasPermissionTo('update-unit_conversation');
        }

        return $user->hasPermissionTo('update-unit_conversation') || $user->id === $model->id;
    }
     ...
     */
    public function delete(User $user, ?UnitConversation $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('delete', User::class)
            return $user->hasPermissionTo('delete-unit_conversation');
        }
