...
class CostCenterPolicy
{
    ...
    {
        return $user->hasPermissionTo('viewAny-cost_center');
    }
     ...
     */
    public function view(User $user, ?CostCenter $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('view', User::class)
            return $user->hasPermissionTo('view-cost_center');
        }

        // instance-based check
        return $user->hasPermissionTo('view-cost_center') || $user->id === $model->id;
    }
    ...
    {
        return $user->hasPermissionTo('create-cost_center');
    }
     ...
     */
    public function update(User $user, ?CostCenter $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('update', User::class)
            return $user->hasPermissionTo('update-cost_center');
        }

        return $user->hasPermissionTo('update-cost_center') || $user->id === $model->id;
    }
     ...
     */
    public function delete(User $user, ?CostCenter $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('delete', User::class)
            return $user->hasPermissionTo('delete-cost_center');
        }
