...
class PeriodPolicy
{
    ...
    {
        return $user->hasPermissionTo('viewAny-period');
    }
     ...
     */
    public function view(User $user, ?Period $model = null): bool
    {
        if ($model === null) {
        ...
        return $user->hasPermissionTo('view-period') || $user->id === $model->id;
    }
     ...
     */
    public function update(User $user, ?Period $model = null): bool
    {
        if ($model === null) {
        ...
        return $user->hasPermissionTo('update-period') || $user->id === $model->id;
    }
     ...
     */
    public function delete(User $user, ?Period $model = null): bool
    {
        if ($model === null) {
