...
class FiscalYearPolicy
{
    ...
    {
        return $user->hasPermissionTo('viewAny-fiscal_year');
    }
     ...
     */
    public function view(User $user, ?FiscalYear $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('view', User::class)
            return $user->hasPermissionTo('view-fiscal_year');
        }

        // instance-based check
        return $user->hasPermissionTo('view-fiscal_year') || $user->id === $model->id;
    }
    ...
    {
        return $user->hasPermissionTo('create-fiscal_year');
    }
     ...
     */
    public function update(User $user, ?FiscalYear $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('update', User::class)
            return $user->hasPermissionTo('update-fiscal_year');
        }

        return $user->hasPermissionTo('update-fiscal_year') || $user->id === $model->id;
    }
     ...
     */
    public function delete(User $user, ?FiscalYear $model = null): bool
    {
        if ($model === null) {
            // class-based check, mis. Gate::authorize('delete', User::class)
            return $user->hasPermissionTo('delete-fiscal_year');
        }
