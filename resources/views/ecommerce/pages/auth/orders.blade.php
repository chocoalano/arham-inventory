                    ...
                    <form action="#">
                        ...
                        <div class="cart-table table-responsive mb-40">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="pro-thumbnail"><a href="single-product.html"><img width="300"
                                                    height="360" src="ecommerce/images/products/product01.webp"
                                        ...
                                        <td class="pro-quantity">
                                            <div class="pro-qty"><input type="text" value="1"><a href="#"
                                                    class="inc qty-btn"><i class="fa fa-angle-up"></i></a><a href="#"
                                                    class="dec qty-btn"><i class="fa fa-angle-down"></i></a></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="pro-thumbnail"><a href="single-product.html"><img width="300"
                                                    height="360" src="ecommerce/images/products/product02.webp"
                                                    class="img-fluid" alt="Product"></a></td>
                                        <td class="pro-title"><a href="single-product.html">Auctor gravida pellentesque</a>
                                        </td>
                                        <td class="pro-price"><span>$30.00</span></td>
                                        <td class="pro-quantity">
                                            <div class="pro-qty"><input type="text" value="2"><a href="#"
                                                    class="inc qty-btn"><i class="fa fa-angle-up"></i></a><a href="#"
                                                    class="dec qty-btn"><i class="fa fa-angle-down"></i></a></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="pro-thumbnail"><a href="single-product.html"><img width="300"
                                                    height="360" src="ecommerce/images/products/product03.webp"
                                                    class="img-fluid" alt="Product"></a></td>
                                    ...
                                    <tr>
                                        <td class="pro-thumbnail"><a href="single-product.html"><img width="300"
                                                    height="360" src="ecommerce/images/products/product04.webp"
                                                    class="img-fluid" alt="Product"></a></td>
                                        <td class="pro-title"><a href="single-product.html">Habitasse dictumst elementum</a>
                                        </td>
                                        ...
                                        <div class="col-md-6 col-12 mb-25">
                                            ...
                                            {{-- <div class="nice-select" tabindex="0"><span class="current">Dhaka</span>
                                                <ul class="list">
                                                    ...
                                                    <li data-value="Khulna" class="option">Khulna</li>
